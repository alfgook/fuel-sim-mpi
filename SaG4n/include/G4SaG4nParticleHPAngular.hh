...
//
#ifndef G4SaG4nParticleHPAngular_h
#define G4SaG4nParticleHPAngular_h 1
...
class G4SaG4nParticleHPAngular
{
   struct toBeCached
   {
...
private:
  ...
  G4SaG4nParticleHPPartial * theProbArray;
