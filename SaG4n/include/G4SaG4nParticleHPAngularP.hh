...
//
#ifndef G4SaG4nParticleHPAngularP_h
#define G4SaG4nParticleHPAngularP_h 1
...
class G4SaG4nParticleHPAngularP
{
  public:
  
  G4SaG4nParticleHPAngularP()
  {
    theCosTh = NULL;
    theProb = NULL;
    theEnergy = 0.;
  ...
  G4SaG4nParticleHPInterpolator theInt; // knows tointerpolate
  G4int nCoeff;
