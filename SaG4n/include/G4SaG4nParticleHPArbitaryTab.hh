...
//
#ifndef G4SaG4nParticleHPArbitaryTab_h
#define G4SaG4nParticleHPArbitaryTab_h 1
...
class G4SaG4nParticleHPArbitaryTab : public G4VParticleHPEDis
{
  public:
  G4SaG4nParticleHPArbitaryTab()
  {
   theDistFunc = 0;
   nDistFunc = 0;
  }
  ...
  inline void Init(std::istream & theData)
  {
    ...
    theDistFunc = new G4SaG4nParticleHPVector [nDistFunc];
  ...
  G4SaG4nParticleHPVector theFractionalProb;
  G4int nDistFunc;
  G4InterpolationManager theManager; // knows the interpolation between stores
  G4SaG4nParticleHPVector * theDistFunc; // one per incoming energy
