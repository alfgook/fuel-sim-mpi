...
//
#ifndef G4SaG4nParticleHPChannelList_h
#define G4SaG4nParticleHPChannelList_h 1
...
{      
  ...
  G4SaG4nParticleHPChannelList(G4int n, G4ParticleDefinition* projectile);
  
  G4SaG4nParticleHPChannelList();
  ...
  void Register(G4SaG4nParticleHPFinalState *theFS, const G4String &aName);
...
private:
  ...
  G4SaG4nParticleHPChannel ** theChannels;
  G4int nChannels;
  G4String theDir;
