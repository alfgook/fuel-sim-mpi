...
//
#ifndef G4SaG4nParticleHPFastLegendre_h
#define G4SaG4nParticleHPFastLegendre_h 1

#include "globals.hh"

class G4SaG4nParticleHPFastLegendre
{
  public:
  
  G4SaG4nParticleHPFastLegendre()
  {
  ...
  G4double Integrate(G4int l, G4double costh)
  {
    ...
    G4double y1, y2;
//    G4cout <<"Testhpw G4SaG4nParticleHPFastLegendre::Integrate "<<l<<" "<<bin<<G4endl;
    y1 = integral[l][bin];
    y2 = integral[l][bin+1];
//    G4cout <<"Testhpw G4SaG4nParticleHPFastLegendre::Integrate exit"<<G4endl;
