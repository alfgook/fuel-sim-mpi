...
//
#ifndef G4SaG4nParticleHPField_h
#define G4SaG4nParticleHPField_h 1

#include "G4SaG4nParticleHPFieldPoint.hh"
#include "G4PhysicsVector.hh"

class G4SaG4nParticleHPField
{
  public:
  
  G4SaG4nParticleHPField();
  ...
  inline G4SaG4nParticleHPFieldPoint & GetPoint(G4int i) { return theData[i]; }
  ...
  G4SaG4nParticleHPFieldPoint * theData;
  G4int nEntries;
  G4int nPoints;
};
