...
//
#ifndef G4SaG4nParticleHPFieldPoint_h
#define G4SaG4nParticleHPFieldPoint_h 1

#include "globals.hh"

class G4SaG4nParticleHPFieldPoint
{
  public:
  
  G4SaG4nParticleHPFieldPoint()
  {
    X = 0;
    nP = 0;
    Y = 0;
  ...
  G4SaG4nParticleHPFieldPoint(G4int n);
  
  void operator= (const G4SaG4nParticleHPFieldPoint & aSet);
