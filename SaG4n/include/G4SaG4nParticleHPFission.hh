...
#ifndef G4SaG4nParticleHPFission_h
#define G4SaG4nParticleHPFission_h 1
...
class G4SaG4nParticleHPFission : public G4HadronicInteraction
{
  public: 
  
  G4SaG4nParticleHPFission();
  ...
  //G4SaG4nParticleHPChannel * theFission;
      std::vector<G4SaG4nParticleHPChannel*>* theFission;
  G4String dirName;
  G4int numEle;
