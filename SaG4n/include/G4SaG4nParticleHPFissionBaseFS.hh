...
//
#ifndef G4SaG4nParticleHPFissionBaseFS_h
#define G4SaG4nParticleHPFissionBaseFS_h 1
...
class G4SaG4nParticleHPFissionBaseFS : public G4SaG4nParticleHPFinalState
{
  struct toBeCached
  {
...
public:
  ...
  G4SaG4nParticleHPFissionBaseFS()
  { 
    hasXsec = true; 
    theXsection = new G4SaG4nParticleHPVector;
  }

  virtual ~G4SaG4nParticleHPFissionBaseFS()
  {
    delete theXsection;
  }
  ...
  virtual G4SaG4nParticleHPVector * GetXsec()
  {
    return theXsection;
  }
