...
//
#ifndef G4SaG4nParticleHPFissionERelease_h
#define G4SaG4nParticleHPFissionERelease_h 1
...
class G4SaG4nParticleHPFissionERelease
{
  public:
     G4SaG4nParticleHPFissionERelease()
     : totalEnergy( 0.0 )
     , fragmentKinetic( 0.0 )
