...
//
#ifndef G4SaG4nParticleHPGamma_h
#define G4SaG4nParticleHPGamma_h 1
...
class G4SaG4nParticleHPGamma
{
  ...
  G4SaG4nParticleHPGamma();
  ~G4SaG4nParticleHPGamma();
  
  G4bool Init(std::istream & aDataFile);
  
  inline void SetNext(G4SaG4nParticleHPLevel * aLevel)
  {
    next = aLevel;
  }
