...
//
#ifndef G4SaG4nParticleHPInterpolator_h
#define G4SaG4nParticleHPInterpolator_h 1
...
class G4SaG4nParticleHPInterpolator
{
  public:
  
  G4SaG4nParticleHPInterpolator(){}
  ~G4SaG4nParticleHPInterpolator()
   {
...
inline G4double G4SaG4nParticleHPInterpolator::
            ...
            G4double x, G4double x1, G4double x2, G4double y1, G4double y2) const
{
  ...
  switch(theScheme)
  {
    ...
    default:
      ...
      throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPInterpolator::Carthesian Invalid InterpolationScheme");
      break;
  }
  return result;
}
