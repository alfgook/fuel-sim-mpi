...
//
#ifndef G4SaG4nParticleHPIsoData_h
#define G4SaG4nParticleHPIsoData_h 1
...
class G4SaG4nParticleHPIsoData
{
public:

  G4SaG4nParticleHPIsoData()
  {
    theChannelData = 0;
    theFissionData = 0;
    theCaptureData = 0;
  ...
  ~G4SaG4nParticleHPIsoData(){if(theChannelData!=0) delete theChannelData;}
  ...
  inline G4SaG4nParticleHPVector * MakeElasticData()
    {return theElasticData;}
  inline G4SaG4nParticleHPVector * MakeFissionData()
    {return theFissionData;}
  inline G4SaG4nParticleHPVector * MakeCaptureData()
    {return theCaptureData;}
  inline G4SaG4nParticleHPVector * MakeInelasticData()
    {return theInelasticData;}
  inline G4SaG4nParticleHPVector * MakeChannelData()
    {return theChannelData;}

  G4String GetName(G4int A, G4int Z, G4String base, G4String rest);
  
  inline void FillChannelData(G4SaG4nParticleHPVector * aBuffer)
  {
...
private:
  ...
  G4SaG4nParticleHPVector * theChannelData;
