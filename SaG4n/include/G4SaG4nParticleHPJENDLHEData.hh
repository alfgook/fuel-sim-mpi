...
//
#ifndef G4SaG4nParticleHPJENDLHEData_h
#define G4SaG4nParticleHPJENDLHEData_h 1
...
class G4SaG4nParticleHPJENDLHEData : public G4VCrossSectionDataSet
{
   public:
   
   G4SaG4nParticleHPJENDLHEData();
   G4SaG4nParticleHPJENDLHEData( G4String , G4ParticleDefinition* );
