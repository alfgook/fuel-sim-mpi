...
//
#ifndef G4SaG4nParticleHPLabAngularEnergy_h
#define G4SaG4nParticleHPLabAngularEnergy_h 1
...
class G4SaG4nParticleHPLabAngularEnergy : public G4VParticleHPEnergyAngular
{
  public:
  
  G4SaG4nParticleHPLabAngularEnergy()
  {
    theEnergies = 0;
    theData = 0;
    nCosTh = 0;
  ...
  G4SaG4nParticleHPVector ** theData; 
