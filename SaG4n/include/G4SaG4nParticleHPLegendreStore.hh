...
//
#ifndef G4SaG4nParticleHPLegendreStore_h
#define G4SaG4nParticleHPLegendreStore_h 1
...
class G4SaG4nParticleHPLegendreStore
{
  public:
  
  G4SaG4nParticleHPLegendreStore(G4int n)
  {
    theCoeff = new G4SaG4nParticleHPLegendreTable[n];
    nEnergy = n;
  }
  
  ~G4SaG4nParticleHPLegendreStore()
  {
    delete [] theCoeff;
  }
  ...
  inline void SetCoeff(G4int i, G4SaG4nParticleHPLegendreTable * theTable)
  {
    if(i>nEnergy) throw G4HadronicException(__FILE__, __LINE__, "LegendreTableIndex out of range");
    theCoeff[i] = *theTable;
// not here -- see G4SaG4nParticleHPPhotonDist.cc line 275
//    delete theTable;
  }
