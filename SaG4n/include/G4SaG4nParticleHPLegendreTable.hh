...
//
#ifndef G4SaG4nParticleHPLegendreTable_h
#define G4SaG4nParticleHPLegendreTable_h 1
...
class G4SaG4nParticleHPLegendreTable
{
  public:
  G4SaG4nParticleHPLegendreTable()
  {
    nCoeff=0; 
    theCoeff = 0;
    theRep = 0;
  ...
  ~G4SaG4nParticleHPLegendreTable(){if(theCoeff!=0) delete [] theCoeff;}
  
  void operator= (const G4SaG4nParticleHPLegendreTable & aSet)
  {
    if(&aSet!=this)
    {
      theRep = aSet.theRep;
  ...
  inline void Init(G4double e, G4int n)
  {
    ...
    theCoeff[0]=1.;
    theEnergy = e;
//    G4cout << "G4SaG4nParticleHPLegendreTable::Init called "<<e<<" "<<n<<G4endl;
  }
