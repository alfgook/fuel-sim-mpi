...
//
#ifndef G4SaG4nParticleHPMadlandNixSpectrum_h
#define G4SaG4nParticleHPMadlandNixSpectrum_h 1
...
class G4SaG4nParticleHPMadlandNixSpectrum : public G4VParticleHPEDis
{
  public:
  G4SaG4nParticleHPMadlandNixSpectrum()
  {
    expm1 = G4Exp(-1.);
...
//    result = nag_exp_integral(aValue, fail); @
  ...
  G4SaG4nParticleHPVector theMaxTemp;
