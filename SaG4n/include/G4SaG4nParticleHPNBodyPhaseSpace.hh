...
//
#ifndef G4SaG4nParticleHPNBodyPhaseSpace_h
#define G4SaG4nParticleHPNBodyPhaseSpace_h 1
...
class G4SaG4nParticleHPNBodyPhaseSpace : public G4VParticleHPEnergyAngular
{
  public:
  
  G4SaG4nParticleHPNBodyPhaseSpace(){
   theTotalMass = 0.0;
   theTotalCount = 0;
  }
  ~G4SaG4nParticleHPNBodyPhaseSpace(){}
