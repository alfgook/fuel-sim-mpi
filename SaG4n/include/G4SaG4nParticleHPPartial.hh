...
//
#ifndef G4SaG4nParticleHPPartial_h
#define G4SaG4nParticleHPPartial_h 1
...
class G4SaG4nParticleHPPartial
{
  public:
  
  G4SaG4nParticleHPPartial(G4int n)
  { 
    X = new G4double[n];
    data = new G4SaG4nParticleHPVector[n];
    nData = n;
    T=0;
  }
  
  G4SaG4nParticleHPPartial(G4int n1, G4int n2)
  {
    T = new G4double[n2];
    X = new G4double[n1];
    data = new G4SaG4nParticleHPVector[n1];
    nData = std::max(n1,n2);
  }  
  ...
  G4SaG4nParticleHPVector * GetY(G4double e1);
