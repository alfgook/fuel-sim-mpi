...
//
#ifndef G4SaG4nParticleHPReactionWhiteBoard_h
#define G4SaG4nParticleHPReactionWhiteBoard_h 1
...
class G4SaG4nParticleHPReactionWhiteBoard 
{
   ...
   public:
      ...
      void SetProjectileKineticEnergy(G4double kinE){proj_KinEne=kinE;}
      G4int GetTargZ(){ return targZ; };
      G4int GetTargA(){ return targA; };
      G4int GetTargM(){ return targM; };
      G4double GetProjectileKineticEnergy(){ return proj_KinEne;}
