...
//
#ifndef G4SaG4nParticleHPThermalScatteringData_h
#define G4SaG4nParticleHPThermalScatteringData_h 1
...
class G4SaG4nParticleHPThermalScatteringData : public G4VCrossSectionDataSet
{

   public:

      G4SaG4nParticleHPThermalScatteringData();
   ...
   private:
      ...
      G4double GetX ( const G4DynamicParticle* , G4double aT , std::map< G4double , G4SaG4nParticleHPVector* >* );
...
//              element            temp       x section from E
      std::map< G4int , std::map< G4double , G4SaG4nParticleHPVector* >* >* coherent;
      std::map< G4int , std::map< G4double , G4SaG4nParticleHPVector* >* >* incoherent;
      std::map< G4int , std::map< G4double , G4SaG4nParticleHPVector* >* >* inelastic;

      std::map< G4double , G4SaG4nParticleHPVector* >* readData ( G4String ); 
