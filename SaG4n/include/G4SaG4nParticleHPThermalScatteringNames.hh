...
//
#ifndef G4SaG4nParticleHPThermalScatteringNames_h
#define G4SaG4nParticleHPThermalScatteringNames_h 1
...
class G4SaG4nParticleHPThermalScatteringNames 
{
   public:
   
      G4SaG4nParticleHPThermalScatteringNames();
