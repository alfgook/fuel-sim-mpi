...
void G4SaG4nParticleHPDeExGammas::Init(std::istream & aDataFile)
{
  //  G4cout << this << "ExGammas Init LEVEL " << G4endl; //GDEB
  G4SaG4nParticleHPGamma ** theGammas = new G4SaG4nParticleHPGamma * [50];
  G4int nGammas = 0;
  G4int nBuff = 50;
  for(;;)
  {
    G4SaG4nParticleHPGamma * theNew = new G4SaG4nParticleHPGamma;
    ...
    else
    {
      ...
      {
        nBuff+=50;
        G4SaG4nParticleHPGamma ** buffer = new G4SaG4nParticleHPGamma * [nBuff];
  ...
  theLevels = new G4SaG4nParticleHPLevel[nLevels];
