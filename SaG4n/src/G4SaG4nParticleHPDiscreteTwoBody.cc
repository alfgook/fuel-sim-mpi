...
G4ReactionProduct * G4SaG4nParticleHPDiscreteTwoBody::Sample(G4double anEnergy, G4double massCode, G4double )
{ // Interpolation still only for the most used parts; rest to be Done @@@@@
   ...
   {
     throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPDiscreteTwoBody: Unknown ion case 2");
   }
