...
G4SaG4nParticleHPFFFissionFS::~G4SaG4nParticleHPFFFissionFS()
{
...
void G4SaG4nParticleHPFFFissionFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & , G4ParticleDefinition*)
{
   //G4cout << "G4SaG4nParticleHPFFFissionFS::Init" << G4endl;
   G4String aString = "FF";

   G4String tString = dirName;
   G4bool dbool;
   G4SaG4nParticleHPDataUsed aFile = theNames.GetName(static_cast<G4int>(A), static_cast<G4int>(Z), M, tString, aString , dbool);
...
G4DynamicParticleVector * G4SaG4nParticleHPFFFissionFS::ApplyYourself(G4int nNeutrons)
{  
   G4DynamicParticleVector * aResult;
//    G4cout <<"G4SaG4nParticleHPFFFissionFS::ApplyYourself +"<<G4endl;
   aResult = G4SaG4nParticleHPFissionBaseFS::ApplyYourself(nNeutrons);    
   return aResult;
}

void G4SaG4nParticleHPFFFissionFS::GetAFissionFragment( G4double energy , G4int& fragZ , G4int& fragA , G4int& fragM )
{
   //G4cout << "G4SaG4nParticleHPFFFissionFS::GetAFissionFragment " << G4endl;
