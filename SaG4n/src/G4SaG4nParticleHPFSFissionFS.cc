...
#include "G4SaG4nParticleHPDataUsed.hh"
  ...
  void G4SaG4nParticleHPFSFissionFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String &, G4ParticleDefinition*  )
  {
    G4String tString = "/FS/";
    G4bool dbool;
    ...
    while (theData >> infoType) // Loop checking, 11.05.2015, T. Koi
    {
      ...
      switch(infoType)
      {
        ...
        case 5:
          ...
          break;
        default:
          G4cout << "G4SaG4nParticleHPFSFissionFS::Init: unknown data type"<<dataType<<G4endl;
          throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPFSFissionFS::Init: unknown data type");
          break;
      }
    }
  ...
  G4DynamicParticleVector * G4SaG4nParticleHPFSFissionFS::ApplyYourself(G4int nPrompt, 
...
void G4SaG4nParticleHPFSFissionFS::SampleNeutronMult(G4int&all, G4int&Prompt, G4int&delayed, G4double eKinetic, G4int off)
{
...
G4DynamicParticleVector * G4SaG4nParticleHPFSFissionFS::GetPhotons()
{
// sample photons
