...
#include "G4SaG4nParticleHPDataUsed.hh"
  ...
  void G4SaG4nParticleHPFissionBaseFS::Init (G4double A, G4double Z, G4int M, G4String & dirName, G4String & bit, G4ParticleDefinition*)
  {
...
G4DynamicParticleVector * G4SaG4nParticleHPFissionBaseFS::ApplyYourself(G4int nPrompt)
  {  
