...
void G4SaG4nParticleHPIsotropic::Init(std::istream & )
{
}

G4ReactionProduct * G4SaG4nParticleHPIsotropic::Sample(G4double anEnergy, G4double massCode, G4double )
{
   ...
   else
   {
     //110607 TK modified following parts for migration to G4NDL3.15 (ENDF VII.r0)
     result->SetDefinition( G4IonTable::GetIonTable()->GetIon ( Z ,  A , 0.0 ) );
     //throw G4HadronicException(__FILE__, __LINE__, "G4SaG4nParticleHPIsotropic: Unknown ion case 2");
   }
