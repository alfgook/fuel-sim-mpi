...
#include "G4SystemOfUnits.hh"
  ...
  G4double G4SaG4nParticleHPMadlandNixSpectrum::Madland(G4double aSecEnergy, G4double tm)
  {
  ...
  G4double G4SaG4nParticleHPMadlandNixSpectrum::Sample(G4double anEnergy) 
  {
  ...
  G4double G4SaG4nParticleHPMadlandNixSpectrum::
