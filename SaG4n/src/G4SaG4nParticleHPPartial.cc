...
G4SaG4nParticleHPVector * G4SaG4nParticleHPPartial::GetY(G4double e1)
  {
    G4SaG4nParticleHPVector * aBuffer = new G4SaG4nParticleHPVector();
    G4int i;
    if(nData==1)
    {
  ...
  G4double G4SaG4nParticleHPPartial::Sample(G4double x)
  {
    G4int i;
    for (i=0; i<nData; i++)
    {
    ...
    G4SaG4nParticleHPVector theBuff;
    if(i==0) 
    {
