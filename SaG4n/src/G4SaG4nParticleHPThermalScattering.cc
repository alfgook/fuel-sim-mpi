...
E_P_E_isoAng* G4SaG4nParticleHPThermalScattering::readAnE_P_E_isoAng( std::istream* file )
{
...
E_isoAng G4SaG4nParticleHPThermalScattering::create_E_isoAng_from_energy ( G4double energy ,  std::vector< E_isoAng* >* vEPM )
{
   E_isoAng anEPM_T_E;
