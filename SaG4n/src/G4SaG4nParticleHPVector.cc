...
#include "G4Threading.hh"
  ...
  G4SaG4nParticleHPVector & operator + (G4SaG4nParticleHPVector & left, G4SaG4nParticleHPVector & right)
  {
    G4SaG4nParticleHPVector * result = new G4SaG4nParticleHPVector;
    G4int j=0;
    G4double x;
    G4double y;
    G4int running = 0;
  ...
  G4SaG4nParticleHPVector::G4SaG4nParticleHPVector()
  {
    theData = new G4SaG4nParticleHPDataPoint[20]; 
    nPoints=20;
    nEntries=0;
    Verbose=0;
    theIntegral=0;
  ...
  G4SaG4nParticleHPVector::G4SaG4nParticleHPVector(G4int n)
  {
    nPoints=std::max(n, 20);
    theData = new G4SaG4nParticleHPDataPoint[nPoints]; 
    nEntries=0;
    Verbose=0;
    theIntegral=0;
    totalIntegral=-1;
  ...
  G4SaG4nParticleHPVector::~G4SaG4nParticleHPVector()
  {
//    if(Verbose==1)G4cout <<"G4SaG4nParticleHPVector::~G4SaG4nParticleHPVector"<<G4endl;
      delete [] theData;
...
//    if(Verbose==1)G4cout <<"Vector: delete theIntegral"<<G4endl;
  ...
  G4SaG4nParticleHPVector & G4SaG4nParticleHPVector::  
  operator = (const G4SaG4nParticleHPVector & right)
  {
  ...
  G4double G4SaG4nParticleHPVector::GetXsec(G4double e) 
  {
  ...
  void G4SaG4nParticleHPVector::Dump()
  {
...
//      if (i!=1&&i==5*(i/5)) G4cout << G4endl;
  ...
  void G4SaG4nParticleHPVector::Check(G4int i)
  {
    if(i>nEntries) throw G4HadronicException(__FILE__, __LINE__, "Skipped some index numbers in G4SaG4nParticleHPVector");
    if(i==nPoints)
    {
      nPoints = static_cast<G4int>(1.2*nPoints);
      G4SaG4nParticleHPDataPoint * buff = new G4SaG4nParticleHPDataPoint[nPoints];
  ...
  void G4SaG4nParticleHPVector::
  Merge(G4InterpolationScheme aScheme, G4double aValue, 
        G4SaG4nParticleHPVector * active, G4SaG4nParticleHPVector * passive)
  { 
  ...
  void G4SaG4nParticleHPVector::ThinOut(G4double precision)
  {
    // anything in there?
    if(GetVectorLength()==0) return;
    // make the new vector
    G4SaG4nParticleHPDataPoint * aBuff = new G4SaG4nParticleHPDataPoint[nPoints];
  ...
  G4bool G4SaG4nParticleHPVector::IsBlocked(G4double aX)
  {
    G4bool result = false;
  ...
  G4double G4SaG4nParticleHPVector::Sample() // Samples X according to distribution Y
  {
    G4double result;
    G4int j;
...
//080807
  ...
  G4double G4SaG4nParticleHPVector::Get15percentBorder()
  {    
  ...
  G4double G4SaG4nParticleHPVector::Get50percentBorder()
  {    
