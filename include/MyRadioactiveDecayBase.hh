...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  File:   MyRadioactiveDecayBase.hh                                         //
...
#ifndef MyRadioactiveDecayBase_h
#define MyRadioactiveDecayBase_h 1
...
class G4Fragment;
class MyRadioactiveDecayBaseMessenger;
class G4PhotonEvaporation;

typedef std::map<G4String, G4DecayTable*> DecayTableMap;


class MyRadioactiveDecayBase : public G4VRestDiscreteProcess 
{
  // class description
  ...
  public: // with description
    ...
    MyRadioactiveDecayBase(const G4String& processName="RadioactiveDecayBase");
    ~MyRadioactiveDecayBase();
    ...
    // Enable/disable ARM
    void SetBRbias(G4bool brBias) {applyBRbias = brBias;}
  ...
  protected:
    ...
    G4DecayProducts* DoDecayBRbias(const G4ParticleDefinition& theParticleDef, G4double &weight);
    ...
    MyRadioactiveDecayBaseMessenger* theRadioactiveDecayBaseMessenger;
  ...
  private:
    ...
    MyRadioactiveDecayBase(const MyRadioactiveDecayBase &right);
    MyRadioactiveDecayBase& operator=(const MyRadioactiveDecayBase &right);
