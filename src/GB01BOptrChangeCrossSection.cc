...
{
  G4cout << "GB01BOptrChangeCrossSection::StartRun()" << G4endl;
  G4cout << "     particle = " << fParticleToBias->GetParticleName()
         << "     biasFactor = " << BiasFactor << G4endl;
  // --------------
  // -- Setup stage:
  // ---------------
...
GB01BOptrChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track, 
                                                              const G4BiasingProcessInterface*
                                                                               callingProcess)
{
  //G4cout << "     biasFactor = " << BiasFactor << G4endl;
  // -----------------------------------------------------
  ...
  //G4cout << "analogInteractionLength = " << analogInteractionLength << G4endl;
                 ...
                 const G4VParticleChange*                                  )
{
  ...
  if ( operation ==  occurenceOperationApplied ) {
    ...
    //G4cout << "operation ==  occurenceOperationApplied" << G4endl;
  }
}
