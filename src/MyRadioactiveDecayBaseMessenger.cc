...
////////////////////////////////////////////////////////////////////////////////
//                                                                            //
//  File:   MyRadioactiveDecayBaseMessenger.cc                                //
...
(MyRadioactiveDecayBase* theRadioactiveDecayContainer1)
:theRadioactiveDecayContainer(theRadioactiveDecayContainer1)
{
  ...
  // Command to invoke branching ratio biasing
  biasBRCmd = new G4UIcmdWithABool ("/grdm/applyBRbias",this);
  biasBRCmd->SetGuidance("True: Brancing ratio biasing is applied; false: not apllied");
  biasBRCmd->SetParameterName("applyBR",true);
  biasBRCmd->SetDefaultValue(true);
  //biasBRCmd->AvailableForStates(G4State_PreInit);
...
void
MyRadioactiveDecayBaseMessenger::SetNewValue(G4UIcommand *command, G4String newValues)
{
